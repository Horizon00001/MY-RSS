...
class Summarizer:
    """AI-powered content summarizer using DeepSeek API."""
    ...
    def __init__(
        ...
        self.api_url = api_url or os.getenv("API_URL", "https://api.deep.deepseek.com/v1")
        self.model = model
    ...
    async def _summarize_one(self, entry: dict) -> dict:
        """Summarize a single entry with semaphore control."""
